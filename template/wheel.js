...
// The branch ring begins at the centre rim. It must not stand off it: a gap
// there fills with the background marble, which is nearly white at that
// radius, and reads as a second light ring around the centre.
// R_IN1 and R_OUT0 are the SAME radius, so the branch/topic boundary is one
// line rather than two.
const R_IN0 = 102, R_IN1 = 197, R_OUT0 = 197, R_OUT1 = 306;
